...
//
#ifndef CS590__RANDOM_GENERATOR_CC__
#define CS590__RANDOM_GENERATOR_CC__
...
char* random_generator::random_string_m(int r_n, int n_ch)
{ /*<<<*/
    char* st;
    int ch;
 ...
 */
    for (int i = 0; i < r_n; i++)
    {
        *this >> ch;
        ...
        st[i] = 'a' + static_cast<char>(ch % n_ch);
    }
